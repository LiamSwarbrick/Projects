...
<img src="files/planetarium-camera-and-entities.gif" alt="Gameplay example", width="32%">
...
<img src="files/planetarium-collision-box.PNG" alt="Collision box from aseprite" width="31%">
